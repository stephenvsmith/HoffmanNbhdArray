...
result_dir <- paste0(home_dir,'/Desktop/','ResultsNbhdArray-',format(Sys.Date(),"%m-%y"))
...
sim_vals <- read.csv(paste0(home_dir,'/Desktop/ResultsNbhdArray-',format(Sys.Date(),"%m-%y"),'/sim_vals.csv'))
